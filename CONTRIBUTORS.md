...
to make via an [issue](https://github.com/sigstore/helm-sigstore/issues).

## Pull Request Process

1. Create an [issue](https://github.com/sigstore/helm-sigstore/issues)
   outlining the fix or feature.
2. Fork the helm-sigstore repository to your own github account and clone it locally.
...
7. Every pull request requires a review from the [core helm-sigstore team](https://github.com/orgs/github.com/sigstore/teams/helm-sigstore-codeowners)
   before merging.
...
helm-sigstore adheres to and enforces the [Contributor Covenant](http://contributor-covenant.org/version/1/4/) Code of Conduct.
Please take a moment to read the [CODE_OF_CONDUCT.md](https://github.com/sigstore/helm-sigstore/blob/master/CODE_OF_CONDUCT.md) document.
